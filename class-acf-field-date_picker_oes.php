...
if( ! class_exists('acf_field_date_picker_oes') ) :

class acf_field_date_picker_oes extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'date_picker_oes';
		$this->label = __("Date Picker OES",'acf');
	...
	*/
	...
	function render_field( $field ) {
		...
		// vars
		$div = array(
			'class'					=> 'acf-date-picker-oes acf-input-wrap',
		...
		if( !empty($field['save_format']) ) {
            ...
            // ToDo: Ilker convert time in U format to m/d/Y
            $convert_format = $field['save_format_convert'];


            if (empty($convert_format)) {
                $convert_format = "m/d/Y";
            }
...
//            error_log("date $value");
            ...
            if ($value) {
                $hidden_input['value'] = date($convert_format, $value);
            } else {
                $hidden_input['value'] = "";
            }
...
// initialize
acf_register_field_type( 'acf_field_date_picker_oes' );
