...
if( ! class_exists('acf_field_file_oes') ) :

class acf_field_file_oes extends acf_field {
	...
	function render_field( $field ) {
		...
		if ($field['mime_types']) {
            ...
            $mime_types_mapping = [
                ...
                'rtf' => 'application/rtf,text/richtext,application/x-rtf,text/rtf',
            ...
            foreach (explode(",",$mime_types) as $ext) {
                $mimetype = $mime_types_mapping[$ext];
                $accepts[] = $mimetype;
            }
	...
	<div class="hide-if-value">
		<?php if( $uploader == 'basic' ): ?>
			...
			<label class="acf-basic-uploader">
				<?php acf_file_input(array( 'name' => $field['name'], 'id' => $field['id'], 'accept' => $accepts, 'required'=>$field['required'] )); ?>
			</label>
...
// initialize
acf_register_field_type( 'acf_field_file_oes' );
