        ...
        return (
            <div {...useBlockProps()}>
                <div className="components-placeholder components-placeholder is-large">
                    <div className="components-placeholder__label">{__('Post Link', 'oes')}</div>
                    ...
                    <div className="oes-block-further-information">{__('You can choose a label ' +
                        'that will be displayed instead of the post display title. ', 'oes')}</div>
