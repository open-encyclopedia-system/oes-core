...
if (!class_exists('Inheritance')) :
    ...
    class Inheritance
    {
        ...
        {
            add_action('oes/datamodel_registered', function () {
         ...
         */
        public function add_overwrite_rule(string $fieldKey, bool $overwrite = true, string $type = 'first')
        {
         ...
         */
        public function add_self_references(string $postID)
        {
         ...
         */
        private function remove_relationship($targetPostId, string $fieldName, $postIdToBeRemoved)
        {
         ...
         * @param string $fieldName The field name to be update.
         * @param int|string $postIdToBeAdded The post relationship to be added.
         */
        private function add_relationship($targetPostId, string $fieldName, $postIdToBeAdded)
        {
            /* 1. get current value of related post ------------------------------------------------------------------*/
            $field = $this->get_field($targetPostId, $fieldName);
