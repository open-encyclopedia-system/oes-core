...
<p>
    <?php printf(__('For more information please visit our %swebsite%s.', 'oes'),
        '<a href="http://www.open-encyclopedia-system.org/" target="_blank">', '</a>'); ?>
</p>
<h1><?php _e('Support', 'oes'); ?></h1>
<div>
    <p>
        <?php printf(__('OES is a free and open source software. The current stable version of OES is 2.0 ' .
...
<h1><?php _e('Configuration', 'oes'); ?></h1>
<div>
    <p>
        <?php _e('OES provides functionalities for custom WordPress post types and taxonomies that are part of an ' .
    ...
    <p>
        <?php
        printf(__('The OES settings extend the WordPress settings. Look %shere%s for the WordPress settings.', 'oes'),
