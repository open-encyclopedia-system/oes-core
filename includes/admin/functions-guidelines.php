...
/**
 * Get the manual string, containing application name and manual.
 *
 * @return string Return the manual string.
 */
function get_manual_string(): string
{
    $title = __('Guidelines', 'oes');
    ...
    return strtoupper(str_replace('-', ' ', $name)) . ' ' . $title;
}
...
/**
 * Display the Guideline overview.
 *
 * @return void
 */
function display_overview(): void
{
    ...
    echo __('Welcome to ' . get_manual_string() . ' — an evolving, collaborative extension of the ', 'oes') .
        ...
        __('. While the general OES Manual provides guides for the standardized technical foundations, this ' .
            'space is dedicated to capturing application-specific knowledge that emerges while building, ' .
            'editing, and maintaining the content of your OES application.', 'oes'); ?></p><?php
...
function register(): void
{
    ...
    new Subpage([
        ...
        'page_parameters' => [
            'parent_slug' => 'admin_manual',
            'page_title' => __('Entries', 'oes'),
            'menu_title' => __('Entries', 'oes'),
...
/**
 * Modify admin menu to show active menu for "Guideline" pages.
 *
