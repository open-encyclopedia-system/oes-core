...
if( ! class_exists('acf_field_message_oes') ) :

class acf_field_message_oes extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'message_oes';
		$this->label = __("Message (OES)",'acf');
	...
	*/
	...
	function render_field( $field ) {
		...
		$m = apply_filters("oes/acf/message/key=".$field['key'], $m, $field);
		$m = apply_filters("oes/acf/message/name=".$field['name'], $m, $field);
...
// initialize
acf_register_field_type( 'acf_field_message_oes' );
